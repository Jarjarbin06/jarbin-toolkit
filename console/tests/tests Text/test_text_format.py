...
from console.jarbin_toolkit_console.Text import Text, Format
from console.jarbin_toolkit_console.ANSI import ANSI
from console.jarbin_toolkit_console.Animation import Animation, ProgressBar, Spinner
from console.jarbin_toolkit_console import (init, quit)
...
def test_format_module_tree():
    ...
    assert "console.jarbin_toolkit_console/" in output
