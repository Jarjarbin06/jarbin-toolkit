...
from console.jarbin_toolkit_console.Text.format import Format
...
class Animation(Format):
    ...
    def __init__(
        ...
        if not isinstance(animation, (list, str)): # pragma: no cover
            from console.jarbin_toolkit_console.Error.error import ErrorType # pragma: no cover
            from console.jarbin_toolkit_console import quit # pragma: no cover
    ...
    def __add__(
        ...
        from console.jarbin_toolkit_console.Text.text import Text
        from console.jarbin_toolkit_console.ANSI.ansi import ANSI
        from console.jarbin_toolkit_console.System.stopwatch import StopWatch
